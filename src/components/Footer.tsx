...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="flex flex-col w-full justify-center px-32 mt-32 items-center gap-5 "
    >
      <div className="flex items-center gap-4 justify-between pt-8 pb-24 mx-[1/4] border-t-2  border-gray-200 w-full">
        <div className="space-y-4 w-[24rem]">
          <h2 className="font-bold text-2xl">About This Page</h2>
